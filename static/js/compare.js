...
function setStat(C /* Cat */, F /* Form */, I /* insert index */, L /* level */) {
	...
	for ([ i, v ] of Object.entries(F.ab)) {
		switch (parseInt(i)) {
		case 1: W(`體力 ${v[0]} % 以下攻擊力增加至 ${100 + v[1]} %`, "IE6ihRp"); break;
		case 2: W(`${v} % 死前存活`, "WcMDxXS"); break;
		case 3: W(`對塔傷害 ${v[0]} % （${numStr(1 + v[0] / 100)}）`, "xIcbDzl");break;
		case 4: W(`${v} % 會心一擊`, "FV6We1L");break;
		case 5: W("終結不死", "ssOFAtR");break;
		case 6: W("靈魂攻擊", "z3SPEqA");break;
		case 7: W(`${v[0]} % 破壞護盾`, "LfRDAkg");break;
		case 8: W(`${v[0]} % 破壞惡魔盾`, "6wjIaUE");break;
		case 9: W(`${v[0]} % 渾身一擊（至${100 + v[1]} %）`, "KDpH72p");break;
		case 10: W("得到很多金錢", "aeG7OM3");break;
		case 11: W("鋼鐵", "MzHKigD");break;
		case 12: W(`${v[0]} % Lv. ${v[1]} 小波動`, "W18c1hw");break;
		case 13: W(`${v[0]} % Lv. ${v[1]} 波動`, "ZbPqGoj");break;
		case 14: W(`${v[0]} % Lv. ${v[4]} 小烈波（${v[1]}～${v[2]}）`, "AEITK8t");break;
		case 15: W(`${v[0]} % Lv${v[4]}烈波（${v[1]}～${v[2]}）`, "at4bW0n");break;
		case 16: W('波動滅止', "BH3LOrK");break;
		case 17: W("超生命體特效", "nGZanly");break;
		case 18: W('超獸特效', "yCMsSbc");break;
		case 19: W('終結魔女', "ktlyJ15");break;
		case 20: W("終結使徒", "y5JJJnJ");break;
		case 21: W(`${v[0]} % 降攻 ${numStrT(1.2 * v[2])}`, "yRkhAHL");break;
		case 22: W(`${v[0]} % 暫停 ${numStrT(1.2 * v[1])}`, 'i1pP3Mi');break;
		case 23: W(`${v[0]} % 緩速 ${numStrT(1.2 * v[1])}`, "MyoCUMu");break;
		case 24: W("只能攻擊", "fe5k3Hw");break;
		case 25: W('善於攻擊', 'dlZ8xNU');break;
		case 26: W('很耐打', '4em8Hzg');break;
		case 27: W('超耐打', 'ck2nA1D');break;
		case 28: W(`超大傷害`, "RbqsryO");break;
		case 29: W('極度傷害', 'whTrzG1');break;
		case 30: W(v[0] + " % 打飛敵人", "cLZsanQ");break;
		case 31: W(v[0] + " % 傳送敵人", "KkYm2Og");break;
		case 32: W(`${v[0]} % 攻擊無效 ${numStrT(v[1])}`, "8Eq6vPV");break;
		case 33: W(`${v[0]} % 詛咒 ${numStrT(1.2 * v[1])}`, "0Rraywl");break;
		case 37: W("一次攻擊", "VY93npj"); break;
		case 40: W('烈波反擊', 'tchDtAr'); break;
		case 42: W('超賢者特效', 'Qq8vQTs'); break;
		case 43: W(`召喚精靈 No. ${v}`, 'AJYPM6p'); break;
		case 44: W(`鋼鐵殺手（-${v}%）`, 'MDuECPl'); break;
		}
	}
